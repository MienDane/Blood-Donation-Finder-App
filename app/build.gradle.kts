...
android {
    namespace = "com.example.project_donate_flood"
    compileSdk = 35
    buildFeatures {
        viewBinding = true
    }
    defaultConfig {
        applicationId = "com.example.project_donate_flood"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
//    implementation(libs.firebase.messaging) // For item_expense.xml
    ...
    implementation ("androidx.gridlayout:gridlayout:1.1.0") // Or a newer version
